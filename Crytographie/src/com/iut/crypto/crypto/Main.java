...
public class Main {
	...
	/*	File source = new File("C:/Users/papy/workspace/Cryptographie/src/com/iut/dev_src/crypto.txt");
		//C:/Users/papy/workspace/Cryptographie/src/com/iut/dev_src
		File dest = new File(
				"C:/Users/papy/workspace/Cryptographie/src/com/iut/dev_src/crypto-encode.txt");
		ICrypto crypto = new CryptoTypeOne();
		crypto.encode(source, dest);

		source = dest;
		dest = new File(
				"C:/Users/papy/workspace/Cryptographie/src/com/iut/dev_src/crypto-decode.txt");
