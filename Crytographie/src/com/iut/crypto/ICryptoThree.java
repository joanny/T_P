...
/**
 * Homophonic Substitution This algorithm gives for a key many different values
...
public interface ICryptoThree extends ICrypto {
	...
	/**
	 * 
	 * This method populates a private map Key will be letters in pattern [a-z]
	 * Values will be numbers on the same line which are separated with ';'
	 */
	public void populateSubstitute();

	/**
	 * This method randomly pick a value corresponding to the specified
	 * <tt>key</tt>
	 * 
	 * @param key
	 *            - Key on which a value will be picked up
